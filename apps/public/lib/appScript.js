...
"use strict";
  ...
  // their first letter for other reasons -- e.g. Pica nuttallii, pinned to
  // March 14 by its "N" for the Pi Day FAQ, contains "TT" and would
  // otherwise get hijacked to day 31 instead.) Each doubled letter is capped
  // by how long the month actually is: OO (28) never fires in February since
  // nothing there is longer than 28 days; RR (30) never fires in a 30-day
  // month, for the same reason -- so the search simply stops before checking
  // PP/RR/SS (or RR/SS) once the month is too short for them to mean
  // anything.
