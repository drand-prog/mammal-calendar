    ...
    return (
      <div className="wrap">
        <div className="login-box">
          <span className="eyebrow">Reptile & Amphibian Ephemeris</span>
          <h1>Admin</h1>
...
function OrdersSection({ initialOrders }: { initialOrders: OrderEntry[] }) {
  ...
  // lopsided (Squamata's four groups alone are well over half of all
  // species) before saving.
  ...
  return (
    <section className="card">
      ...
      <p className="section-note">
        Reptiles and amphibians split into a fixed {initialOrders.length} groups (tortoises/turtles,
        crocodilians, four squamate groups, three frog groups, salamanders, and caecilians — see
        scripts/fetch_reptile_amphibian_data.py for exactly how each is resolved from GBIF). Each one
        needs assigning to a month by hand before its species show up on the public calendar. More than
        one group can share a month.
      </p>
