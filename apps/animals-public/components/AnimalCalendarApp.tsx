...
import familiesData from "../../../data/animals/families.json";
import orderData from "../../../data/animals/orders.json";
import initialFaqs from "../../../data/animals/faqs.json";
import monthDescriptions from "../../../data/animals/monthDescriptions.json";
import { BODY_HTML } from "@/lib/bodyMarkup";
import { initAnimalCalendarApp } from "@/lib/appScript";
...
export default function AnimalCalendarApp({ content }: { content: SiteContent }) {
  const started = useRef(false);

  useEffect(() => {
    if (started.current) return;
    started.current = true;
    initAnimalCalendarApp(familiesData, orderData, initialFaqs, content.browsePrompt, monthDescriptions);
  }, []);
  ...
  // initAnimalCalendarApp wires it up imperatively after mount.
