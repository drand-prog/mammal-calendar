...
function loadTitle(): string {
  ...
  return content.title || "The Reptile & Amphibian Ephemeris";
}

export const metadata: Metadata = {
  title: loadTitle(),
  description:
    "Search any reptile or amphibian by common or scientific name to find the day, hour, and minute it's assigned — month by group, date and time by the letters of its own name.",
